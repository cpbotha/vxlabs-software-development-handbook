...
More subtly, but importantly, is that Django's structure and good conventions
means that your team is working /consistently/ over the whole project, and also
across projects.
