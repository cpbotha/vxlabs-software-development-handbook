...
** TODO Commit atomic changes and describe each one carefully
...
- squash only when *really* needed (???)
  ...
  - also when you squash everything together, there is the tendency to pack
    more than one thing into the change!
  - bisecting / finding the exact change that introduced a bug
