...
1. It enables the flexible specification of dependencies, but through its
   ...
   reproduce /exactly/ the exact versions of dependencies on other
   systems. This is crucially important when we want to develop, test
   (especially in CI) and deploy on systems that are the same down to the
   package hashes.
...
** TODO Name your effects

** TODO Use ducks to organize your Redux  
